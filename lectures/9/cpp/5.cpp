...
RT sq_rect(T1 a, T2 b) // auto - возвращаемый тип, компилятор сам определит тип возвращаемого значения с C++14
{
    return a * b;
}
...
int main()
{
    ...
    std::cout << "Area of rectangle (double, double): " << sq_rect<int>(x, y) << std::endl; 
